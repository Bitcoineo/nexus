    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="min-h-[80vh] flex flex-col items-center justify-center px-6 pt-32 pb-16">
        <div className="max-w-2xl text-center">
          <h1
            className="text-4xl sm:text-5xl font-bold tracking-tight text-balance animate-fade-in-up"
          >
          ...
          <div className="mt-10 max-w-xl mx-auto shadow-xl rounded-xl overflow-hidden">
            ...
            <div className="bg-code-bg p-5 text-left text-sm font-mono overflow-x-auto">
              <div className="animate-type-line" style={{ animationDelay: "600ms" }}>
              ...
              <div className="pl-4 text-gray-500 animate-type-line" style={{ animationDelay: "800ms" }}>
                https://api.nexus.dev/v2/notes
              </div>
              <div className="mt-3 text-gray-500 animate-type-line" style={{ animationDelay: "1000ms" }}>
                {"{"}
              </div>
              <div className="pl-4 animate-type-line" style={{ animationDelay: "1100ms" }}>
                <span className="text-blue-400">&quot;data&quot;</span>
                <span className="text-gray-500">: [{"{"}</span>
              </div>
              <div className="pl-8 animate-type-line" style={{ animationDelay: "1200ms" }}>
                <span className="text-blue-400">&quot;id&quot;</span>
                <span className="text-gray-500">: </span>
                <span className="text-green-400">&quot;n_a1b2c3&quot;</span>
                <span className="text-gray-500">,</span>
              </div>
              <div className="pl-8 animate-type-line" style={{ animationDelay: "1300ms" }}>
                <span className="text-blue-400">&quot;title&quot;</span>
                <span className="text-gray-500">: </span>
                <span className="text-green-400">&quot;My first note&quot;</span>
                <span className="text-gray-500">,</span>
              </div>
              <div className="pl-8 animate-type-line" style={{ animationDelay: "1400ms" }}>
              ...
              <div className="pl-4 animate-type-line" style={{ animationDelay: "1500ms" }}>
                <span className="text-gray-500">{"}"}]</span>
              </div>
              <div className="animate-type-line" style={{ animationDelay: "1600ms" }}>
                <span className="text-gray-500">{"}"}</span>
                <span
